  ...
  <body>
    <div class="container">
      ...
      <a class="btn btn-warning ms-3" href="form-pemesanan.php" role="button"
        >Pesan Tiket</a
      >
      <a class="btn btn-warning ms-3" href="tabel-harga.php" role="button"
        >Daftar Harga</a
      >

      <br /><br />

      <h2>Carousel Bus Kelas Eksekutif</h2>
      <!-- kelas eksekutif -->
      <div
      ...
      <h2>Carousel Bus Kelas Bisnis</h2>
      <!-- kelas Bisnis -->
      <div
      ...
      <h2>Carousel Bus Kelas Ekonomi</h2>
      <!-- kelas ekonomi -->
      <div
